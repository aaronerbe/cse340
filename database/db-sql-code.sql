...
ALTER TABLE IF EXISTS public.inventory
	...
	FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE	ON DELETE NO ACTION;
...
-- FROM Assignment
-- fix Hummer Description (#4)
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'the small interiors', 'a huge interior')
WHERE inv_id = 10;

-- fix images paths for pics and thumbnails
UPDATE public.inventory
...
ALTER TABLE IF EXISTS public.review
    ...
    FOREIGN KEY (account_id) REFERENCES public.account (account_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;

-- Add foreign key constraint for inv_id
ALTER TABLE IF EXISTS public.review
    ADD CONSTRAINT fk_inventory
    FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;

-- Insert multiple rows into the review table
INSERT INTO public.review (review_text, account_id, inv_id)
VALUES 
    ('New Creepy guy in town', 18, 3),
    ('Who needs an icecream truck when you have this beauty', 21, 3);
