...
Core Frontend Design given. Course is building backend services + views for various services (login forms, account management forms, classification forms, inventory forms, reviews forms). Validation + Error Handling for all routes. Used render.com to serve. Technologies: Node.js, Express, JWT, PostgreSQL.
...
- `GET /` - Default view for successful login (account management view) /management
...
- `POST /update-account/:account_id` - Post Update account form
